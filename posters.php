...
$fetchdb = "SELECT * FROM uploads WHERE image_category='Posters' ORDER BY reg_date DESC";
...
<center><h1><strong><img src="assets/default/images/posters_2.png"></img></strong></h1></center> <hr>
